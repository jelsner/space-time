...
Create the folder and file names as character strings. Read the rasters for one year and create a stack. About 70 sec per year to read rasters and create a stack. 11 hours
```{r}
...
```{r}
writeRaster(tmaxDaily, 
            file = "tmaxDaily.nc",
            overwrite = TRUE)

tmaxDaily <- brick("tmaxDaily.nc")
...
This took 77 hr for years 1990-2009 (20 years)
